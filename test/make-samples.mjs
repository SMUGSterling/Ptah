...
// a note, and a tiny embedded reference image. CI validates it with Pixar's
// usd-core (test/usd-validate.py).
...
const objects = [
  O('Floor', 'plane', { x: 0, y: 0, z: 0 }, { x: 1024, y: 1, z: 1024 }, { color: [0.34, 0.37, 0.42] }),
  O('Wall 01', 'cube', { x: 128, y: 32, z: -64 }, { x: 256, y: 64, z: 16 }, { rotation: { x: 0, y: 45, z: 0 } }),
